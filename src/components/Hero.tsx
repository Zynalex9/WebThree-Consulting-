...
const Hero = () => {
  ...
  return (
    <>
      <section className="text-center w-full px-6 md:py-4 md:px-24 min-h-[65vh] flex justify-center items-center flex-col border-b overflow-hidden">
        <div className="w-full max-w-[90vw] mx-auto border-l border-r pl-4">
          <div className="flex w-full items-center justify-center pt-4">
            <h1 className="textanimate font-Thunder text-8xl md:text-[200px] flex items-center">
              WE HELP
            ...
            <svg
              ...
              className="w-[80px] h-[80px] md:w-[350px] md:h-[250px] md:inline-block ml-4 hidden "
            >
              <defs>
          ...
          <h1 className="textanimate font-Thunder font-normal text-8xl  md:text-[190px] text-wrap uppercase ">
            PROJECTS launch.
          </h1>
          <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 10000 4160"
              preserveAspectRatio="xMidYMid meet"
              className="w-[200px] h-[200px] md:w-[350px] md:h-[250px] inline-block ml-4 md:hidden "
            >
              <defs>
                <clipPath id="clipPath">
                  <rect width="10000" height="4160" />
